    ...
    <section id="about" className="py-24 bg-black relative overflow-hidden">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <article className="text-gray-300 leading-relaxed">
          ...
          <p className="text-body-lg">
            Attraverso dati transazionali, dati conversazionali e canali digitali di relazione, aiutiamo le aziende a comprendere meglio bisogni, comportamenti e intenzioni dei propri clienti, per costruire offerte, comunicazioni e customer journey <span className="text-white font-medium">più rilevanti, contestuali e misurabili</span>. A questo si affianca una competenza consolidata nei <span className="text-primary font-medium">Next-Gen Digital Payments</span> e nella <span className="text-primary font-medium">Payments &amp; Transaction Intelligence</span>.
          </p>
        </article>
      </div>
    </section>
